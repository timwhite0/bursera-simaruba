...
ggsave("figures/not_in_manuscript/stem_density_sizeclass_noseedlings_pointrange.png", height = 4, width = 8)
...
stemden_sizeclass_fig1_seedlings <- stemden_mean_data_seedlings %>%
  ...
  labs(x = "Size class", y = "Average number of stems per hectare") +
  guides(col=guide_legend(title = "Plot status"))
ggsave("figures/not_in_manuscript/stem_density_sizeclass_seedlings_pointrange.png", height = 4, width = 8)
...
ggsave("figures/stem_density_sizeclass_noseedlings.png", height = 4, width = 8)
...
stemden_sizeclass_fig2_seedlings <- stemden_mean_data_seedlings %>%
  ...
  labs(x = "Size class", y = "Average number of stems per hectare") +
  guides(fill=guide_legend(title = "Plot status"))
ggsave("figures/stem_density_sizeclass_seedlings.png", height = 4, width = 8)
...
stemden_sizeclass_fig3_noseedlings <- stemden_dist_data_noseedlings %>%
  ggplot() +
    ...
    labs(x = "Size class", y = "Number of stems per hectare") +
    guides(fill = guide_legend(title = "Plot status"))
ggsave("figures/not_in_manuscript/stem_density_sizeclass_noseedlings_boxplot.png", height = 4, width = 8)
...
stemden_sizeclass_fig3_seedlings <- stemden_dist_data_seedlings %>%
  ...
  labs(x = "Size class", y = "Number of stems per hectare") +
  guides(fill = guide_legend(title = "Plot status"))
ggsave("figures/not_in_manuscript/stem_density_sizeclass_seedlings_boxplot.png", height = 4, width = 8)
