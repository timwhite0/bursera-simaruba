...
ggsave("figures/not_in_manuscript/stem_density_harvest_boxplot.png", height = 4, width = 6)
stemden_fig1
...
ggsave("figures/not_in_manuscript/stem_density_vegetation_boxplot.png", height = 4, width = 6)
stemden_fig2
...
ggsave("figures/not_in_manuscript/stem_density_milpa_boxplot.png", height = 4, width = 6)
stemden_fig3
...
stemden_fig_combined <- stemden_fig1 +
  ...
  plot_layout(ncol = 3)
ggsave("figures/stem_density_boxplots.png", stemden_fig_combined, height = 4, width = 8)
