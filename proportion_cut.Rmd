---
title: "\\textbf{Proportion of cut trees in harvested plots}"
...
Note that "cortado" and "cut" are used interchangeably throughout this document.
...
ggsave("figures/not_in_manuscript/cut_proportion_by_plot.png", height = 4, width = 6)
propcut_fig1

propcut_fig2 <- prop_cortado %>%
  filter(harvested == "yes") %>%
...
ggsave("figures/cut_status_by_plot.png", height = 4, width = 6)
propcut_fig2
```
